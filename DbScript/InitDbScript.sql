USE [master]
GO
/****** Object:  Database [EmployeeDb]    Script Date: 9/27/2022 11:00:52 PM ******/
...
USE [EmployeeDb]
GO
/****** Object:  Table [dbo].[Break]    Script Date: 9/27/2022 11:00:52 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Employee]    Script Date: 9/27/2022 11:00:52 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Leave]    Script Date: 9/27/2022 11:00:52 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Shift]    Script Date: 9/27/2022 11:00:52 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
SET IDENTITY_INSERT [dbo].[Break] ON 
GO
INSERT [dbo].[Break] ([Id], [StartTime], [EndTime], [EmployeeId]) VALUES (1, CAST(N'12:00:00' AS Time), CAST(N'13:00:00' AS Time), 1)
GO
INSERT [dbo].[Break] ([Id], [StartTime], [EndTime], [EmployeeId]) VALUES (2, CAST(N'17:00:00' AS Time), CAST(N'18:00:00' AS Time), 2)
GO
INSERT [dbo].[Break] ([Id], [StartTime], [EndTime], [EmployeeId]) VALUES (3, CAST(N'15:00:00' AS Time), CAST(N'16:00:00' AS Time), 1)
GO
INSERT [dbo].[Break] ([Id], [StartTime], [EndTime], [EmployeeId]) VALUES (4, CAST(N'12:00:00' AS Time), CAST(N'13:00:00' AS Time), 3)
GO
SET IDENTITY_INSERT [dbo].[Break] OFF
GO
SET IDENTITY_INSERT [dbo].[Employee] ON 
GO
INSERT [dbo].[Employee] ([Id], [EmployeeName]) VALUES (1, N'Muhammad Irfan')
GO
INSERT [dbo].[Employee] ([Id], [EmployeeName]) VALUES (2, N'Ali Danish')
GO
INSERT [dbo].[Employee] ([Id], [EmployeeName]) VALUES (3, N'Ahmed')
GO
SET IDENTITY_INSERT [dbo].[Employee] OFF
GO
SET IDENTITY_INSERT [dbo].[Leave] ON 
GO
INSERT [dbo].[Leave] ([Id], [StartTime], [EndTime], [EmployeeId]) VALUES (1, CAST(N'16:00:00' AS Time), CAST(N'18:00:00' AS Time), 1)
GO
INSERT [dbo].[Leave] ([Id], [StartTime], [EndTime], [EmployeeId]) VALUES (2, CAST(N'18:00:00' AS Time), CAST(N'21:00:00' AS Time), 2)
GO
SET IDENTITY_INSERT [dbo].[Leave] OFF
GO
SET IDENTITY_INSERT [dbo].[Shift] ON 
GO
INSERT [dbo].[Shift] ([Id], [StartTime], [EndTime], [EmployeeId]) VALUES (1, CAST(N'09:00:00' AS Time), CAST(N'18:00:00' AS Time), 1)
GO
INSERT [dbo].[Shift] ([Id], [StartTime], [EndTime], [EmployeeId]) VALUES (2, CAST(N'12:00:00' AS Time), CAST(N'20:00:00' AS Time), 2)
GO
INSERT [dbo].[Shift] ([Id], [StartTime], [EndTime], [EmployeeId]) VALUES (3, CAST(N'09:00:00' AS Time), CAST(N'18:00:00' AS Time), 3)
GO
SET IDENTITY_INSERT [dbo].[Shift] OFF
GO
ALTER TABLE [dbo].[Break]  WITH CHECK ADD  CONSTRAINT [FK_Break_Employee] FOREIGN KEY([EmployeeId])
REFERENCES [dbo].[Employee] ([Id])
GO
ALTER TABLE [dbo].[Break] CHECK CONSTRAINT [FK_Break_Employee]
GO
